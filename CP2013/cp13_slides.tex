...
\subsection{Integration practical aspects}
	...
	\frametitle{Linear approximation}
		...
		\column{.6\textwidth}
		\centering
		\includegraphics[width=0.7\columnwidth]{incComparePiecewise}
		\end{columns}
	\end{frame}
...
\subsection{Integration results}
	...
	\frametitle{Funds allocation results}
			\begin{table}
				\caption{Funds Allocation - \only<1>{\euro5M} \only<2>{\euro20M}}
...
\section{Conclusion and future works}
	...
	\begin{frame}
      \begin{center}
        ...
        \includegraphics[scale=.5]{epolicyLowerLogo}
      \end{center}
